...
public class PowerPaintPanel extends JPanel {
    ...
    /**
     * check for drawing square/circle option.
     */
    private boolean mySquareCircleIsSelected;
    ...
    */
    ...
    /**
     * set the square/circle option.
     * @param theSC the square/circle
     */
    public void setSquareCircle(final boolean theSC) {
        mySquareCircleIsSelected = theSC;
        repaint();
    }
    ...
    private class MouseActionTracker extends MouseInputAdapter implements MouseInputListener {
        ...
        public void mouseReleased(final MouseEvent theEvent) { 
            ...
            myShape = myShapeTools.setStartPoint(theEvent.getPoint());
         //   myShapeCheck = ;
